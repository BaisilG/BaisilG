...
```typescript
const baisil = {
  name:        "Baisil Geevarghese",
  location:    "London, UK 🇬🇧",
  focus:       ["AI", "Automation", "RPA", "Future Tech"],
  certifiedIn: [
  ...
  exploring:   ["LLMs", "AI Agents", "Agentic Workflows", "n8n"],
  mindset:     "Technology should work for people, not the other way around.",
};
```
...
![Microsoft PL-500](https://img.shields.io/badge/Microsoft_PL--500-Power_Automate-0078D4?style=for-the-badge&logo=microsoft&logoColor=white)
...
> I spend my spare time building **free, nonprofit projects** that are publicly available and help people.
> All projects here are personal passion projects — built to learn, give back, and solve real problems.
